...
cnn = OCRNUM()
cnn.load_state_dict(torch.load("./weights/cnn2.pth"))
cnn.eval()
...
def predict(image: Image.Image, bin_threshold=65, dilate_kernel_size=(3, 3)) -> str:
